...
from gchub_db.includes.windows_notifications import WindowsNotificationManager, NOTIFICATIONS_AVAILABLE
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if test_mode:
                ...
                messages.error(request, 'Please select target groups or choose to send to all users.')
