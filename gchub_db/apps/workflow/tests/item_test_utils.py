...
class ItemTestMixin:
    ...
    def create_beverage_item(self, **kwargs):
        ...
        bev_site = Site.objects.create(name="Beverage", domain="beverage.example.com")
...
class ItemTestData:
    ...
    # Sample item types
    ITEM_TYPES = ["Carton", "Label", "Sleeve", "Wrap", "Box", "Container"]
    ...
    # Sample materials
    MATERIALS = ["SBS", "Kraft", "Clay Coated", "White Board", "Corrugated"]

    # Sample UPC numbers
    UPC_NUMBERS = ["123456789012", "987654321098", "111222333444", "555666777888"]
