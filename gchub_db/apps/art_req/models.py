...
class ArtReq(models.Model):
    ...
    design_name = models.CharField(max_length=255, help_text="Primary design identifier")
    contact_name = models.CharField(max_length=255, help_text="Primary contact for this request")
    contact_email = models.EmailField(max_length=255, help_text="Primary contact email for this request")
    ...
    mkt_segment = models.ForeignKey(MarketSegment, on_delete=models.CASCADE, verbose_name="Market Segment")
    print_type = models.CharField(max_length=25, choices=PrintTypeChoices.choices, verbose_name="Print Type")
    printgroup = models.ForeignKey(QAD_PrintGroups, on_delete=models.CASCADE, verbose_name="Print Group")
...
class AdditionalInfo(models.Model):
    ...
    forecast = models.CharField(verbose_name="Forecast", choices=ForecastChoices.choices, max_length=255)
