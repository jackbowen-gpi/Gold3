...
from gchub_db.apps.django_su.forms import UserSuForm
from gchub_db.apps.django_su.utils import can_su_login
...
def su_login(request, user_form=UserSuForm):
    ...
    return render(request, "su/login.html", context={"form": form})
